...
class Calculator:
    ...
    def create_display_labels(self):
        total_label = tk.Label(self.display_frame, text=self.total_expression, anchor=tk.E, bg=glacier, fg=black, padx=24,font=Small_Arial)
        total_label.pack(expand=True, fill="both")

        label = tk.Label(self.display_frame, text=self.current_expression, anchor=tk.E, bg=glacier, fg=black, padx=24,font=Large_Font)
